...
export const appPages = {
	...
	northEastLinkPages: {
		id: 'northEastLinkApp',
		to: '/north-east-link',
		text: 'North East Link',
		icon: 'HeroBuildingOffice',
		subPages: {
			dashboardPage: {
				id: 'northEastLinkDashboardPage',
				to: '/north-east-link',
				text: 'Dashboard',
				icon: 'HeroChartBar',
			},
			projectsPage: {
				id: 'northEastLinkProjectsPage',
				to: '/north-east-link/projects',
				text: 'Projects',
				icon: 'HeroBuildingOffice',
			},
			resourcesPage: {
				id: 'northEastLinkResourcesPage',
				to: '/north-east-link/resources',
				text: 'Resources',
				icon: 'HeroTruck',
			},
			safetyPage: {
				id: 'northEastLinkSafetyPage',
				to: '/north-east-link/safety',
				text: 'Safety',
				icon: 'HeroExclamationTriangle',
			},
			reportsPage: {
				id: 'northEastLinkReportsPage',
				to: '/north-east-link/reports',
				text: 'Reports',
