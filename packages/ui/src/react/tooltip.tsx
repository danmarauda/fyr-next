	...
	return (
		<TooltipPrimitive.Portal>
			<TooltipPrimitive.Content
				className={cn(
					'fade-in-0 zoom-in-95 data-[side=bottom]:slide-in-from-top-2 data-[side=left]:slide-in-from-right-2 data-[side=right]:slide-in-from-left-2 data-[side=top]:slide-in-from-bottom-2 data-[state=closed]:fade-out-0 data-[state=closed]:zoom-out-95 origin-(--radix-tooltip-content-transform-origin) animate-in bg-primary text-primary-foreground data-[state=closed]:animate-out z-50 w-fit text-balance rounded-md px-3 py-1.5 text-xs',
					className,
				)}
