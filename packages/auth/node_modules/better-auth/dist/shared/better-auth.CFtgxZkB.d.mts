...
import { b as LiteralUnion, L as LiteralString, A as Awaitable, D as DeepPartial, U as UnionToIntersection, a as Prettify, S as StripEmptyObjects, O as OmitId, P as PrettifyDeep, E as Expand } from './better-auth.DTtXpZYr.mjs';
import { b as OAuthProvider, S as SocialProviders, c as SocialProviderList, O as OAuth2Tokens, a as OAuth2UserInfo } from './better-auth.XefKa8DI.mjs';
...
declare const betterAuth: <O extends BetterAuthOptions>(options: O & Record<never, never>) => {
    ...
    api: InferAPI<{
            ...
            <AsResponse extends boolean = false, ReturnHeaders extends boolean = false>(inputCtx_0: {
                ...
                response: {
                    session: UnionToIntersection<StripEmptyObjects<{
                        ...
                        ipAddress?: string | null | undefined;
                        userAgent?: string | null | undefined;
                    } & (O & Record<never, never> extends infer T_1 ? T_1 extends O & Record<never, never> ? T_1 extends BetterAuthOptions ? AdditionalSessionFieldsOutput<T_1> : T_1 extends Auth ? AdditionalSessionFieldsOutput<T_1["options"]> : {} : never : never)>>;
                    user: UnionToIntersection<StripEmptyObjects<{
                        id: string;
                        createdAt: Date;
                        updatedAt: Date;
                        ...
                        name: string;
                        image?: string | null | undefined;
                    } & (O & Record<never, never> extends infer T_2 ? T_2 extends O & Record<never, never> ? T_2 extends BetterAuthOptions ? AdditionalUserFieldsOutput<T_2> : T_2 extends Auth ? AdditionalUserFieldsOutput<T_2["options"]> : {} : never : never)>>;
                } | null;
            } : {
                session: UnionToIntersection<StripEmptyObjects<{
                    id: string;
                    ...
                    ipAddress?: string | null | undefined;
                    userAgent?: string | null | undefined;
                } & (O & Record<never, never> extends infer T_3 ? T_3 extends O & Record<never, never> ? T_3 extends BetterAuthOptions ? AdditionalSessionFieldsOutput<T_3> : T_3 extends Auth ? AdditionalSessionFieldsOutput<T_3["options"]> : {} : never : never)>>;
                user: UnionToIntersection<StripEmptyObjects<{
                    id: string;
                    createdAt: Date;
                    updatedAt: Date;
                    ...
                    name: string;
                    image?: string | null | undefined;
                } & (O & Record<never, never> extends infer T_4 ? T_4 extends O & Record<never, never> ? T_4 extends BetterAuthOptions ? AdditionalUserFieldsOutput<T_4> : T_4 extends Auth ? AdditionalUserFieldsOutput<T_4["options"]> : {} : never : never)>>;
            } | null>;
            options: {
                method: "GET";
                query: z.ZodOptional<z.ZodObject<{
                ...
                metadata: {
                    $Infer: {
                        body: {
                            ...
                            callbackURL?: string;
                            rememberMe?: boolean;
                        } & InferFieldsFromPlugins<O & Record<never, never>, "user", "input"> & InferFieldsFromOptions<O & Record<never, never>, "user", "input">;
                    };
                    openapi: {
                        description: string;
                        requestBody: {
        ...
        updateUser: {
            <AsResponse extends boolean = false, ReturnHeaders extends boolean = false>(...inputCtx: better_call.HasRequiredKeys<better_call.InputContext<"/update-user", {
                ...
                metadata: {
                    $Infer: {
                        body: Partial<AdditionalUserFieldsInput<O & Record<never, never>>> & {
                            name?: string;
                            image?: string;
                        };
                    };
                ...
                use: any[];
            }, Partial<AdditionalUserFieldsInput<O & Record<never, never>>> & {
                name?: string;
                image?: string;
            }> & {
                method?: "POST" | undefined;
        ...
        listSessions: {
            <AsResponse extends boolean = false, ReturnHeaders extends boolean = false>(inputCtx_0: {
                ...
                ipAddress?: string | null | undefined;
                userAgent?: string | null | undefined;
            } & (O & Record<never, never> extends infer T_2 ? T_2 extends O & Record<never, never> ? T_2 extends BetterAuthOptions ? AdditionalSessionFieldsOutput<T_2> : T_2 extends Auth ? AdditionalSessionFieldsOutput<T_2["options"]> : {} : never : never)>>>[]>;
            options: {
                method: "GET";
                use: ((inputContext: better_call.MiddlewareInputContext<better_call.MiddlewareOptions>) => Promise<{
                    session: {
    ...
    } & UnionToIntersection<(O & Record<never, never>)["plugins"] extends (infer T)[] ? T extends BetterAuthPlugin ? T extends {
        endpoints: infer E;
    } ? E : {} : {} : {}>>;
    options: O;
...
export { betterAuth as O, init as X, listSessions as a$, levels as a4, shouldPublishLog as a5, createLogger as a9, parseAccountInput as aA, parseSessionInput as aB, mergeSchema as aC, createCookieGetter as aD, getCookies as aE, setCookieCache as aG, setSessionCookie as aH, deleteSessionCookie as aI, parseCookies as aJ, getSessionCookie as aL, getCookieCache as aM, parseSetCookieHeader as aN, checkEndpointConflicts as aO, getEndpoints as aP, router as aQ, signInSocial as aR, signInEmail as aS, callbackOAuth as aT, getSessionQuerySchema as aU, getSession as aV, getSessionFromCtx as aW, sessionMiddleware as aX, sensitiveSessionMiddleware as aY, requestOnlySessionMiddleware as aZ, freshSessionMiddleware as a_, logger as aa, createInternalAdapter as ab, createFieldAttribute as ad, getAuthTables as am, coreSchema as an, accountSchema as ao, userSchema as ap, sessionSchema as aq, verificationSchema as ar, parseOutputData as as, getAllFields as at, parseUserOutput as au, parseAccountOutput as av, parseSessionOutput as aw, parseInputData as ax, parseUserInput as ay, parseAdditionalUserInput as az, BASE_ERROR_CODES as b, revokeSession as b0, revokeSessions as b1, revokeOtherSessions as b2, signOut as b3, requestPasswordReset as b4, forgetPassword as b5, requestPasswordResetCallback as b6, forgetPasswordCallback as b7, resetPassword as b8, createEmailVerificationToken as b9, sendVerificationEmailFn as ba, sendVerificationEmail as bb, verifyEmail as bc, updateUser as bd, changePassword as be, setPassword as bf, deleteUser as bg, deleteUserCallback as bh, changeEmail as bi, error as bj, ok as bk, signUpEmail as bl, listUserAccounts as bm, linkSocialAccount as bn, unlinkAccount as bo, getAccessToken as bp, refreshToken as bq, accountInfo as br, originCheckMiddleware as bs, originCheck as bt, checkPassword as g, setCookieToHeader as s, optionsMiddleware as w, createAuthMiddleware as x, createAuthEndpoint as y };
export type { AdapterInstance as $, AdapterDebugLogs as A, BetterAuthOptions as B, CustomAdapter as C, AuthMiddleware as D, FieldType as E, FilterActions as F, GenericEndpointContext as G, HookEndpointContext as H, InferOptionSchema as I, FieldAttributeConfig as J, KyselyDatabaseType as K, TelemetryEvent as L, FieldAttribute as M, Models as N, AdditionalSessionFieldsInput as P, Account as Q, RateLimit as R, Session as S, TelemetryContext as T, User as U, Verification as V, WithJsDoc as W, Where as Y, TransactionAdapter as Z, AdapterSchemaCreation as _, Adapter as a, SecondaryStorage as a0, FilteredAPI as a1, InferSessionAPI as a2, LogLevel as a3, Logger as a6, LogHandlerParams as a7, InternalLogger as a8, BetterAuthCookies as aF, EligibleCookies as aK, InternalAdapter as ac, InferValueType as ae, InferFieldsOutput as af, InferFieldsInput as ag, InferFieldsInputClient as ah, FieldAttributeToObject as ai, InferAdditionalFieldsFromPluginOptions as aj, PluginFieldAttribute as ak, BetterAuthDbSchema as al, Auth as c, AuthContext as d, InferUser as e, InferSession as f, InferAPI as h, AdditionalSessionFieldsOutput as i, AdditionalUserFieldsOutput as j, InferFieldsFromPlugins as k, InferFieldsFromOptions as l, AdditionalUserFieldsInput as m, BetterAuthPlugin as n, InferPluginTypes as o, InferPluginErrorCodes as p, AdapterFactoryOptions as q, AdapterFactoryConfig as r, AdapterFactoryCustomizeAdapterCreator as t, AdapterTestDebugLogs as u, AuthPluginSchema as v, AuthEndpoint as z };
