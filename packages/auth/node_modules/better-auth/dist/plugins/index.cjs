...
const organization = require('../shared/better-auth.DHAY0xdm.cjs');
...
const admin = require('../shared/better-auth.BQvT5jPC.cjs');
...
const plugins_oidcProvider_index = require('../shared/better-auth.CB248hqi.cjs');
const plugins_captcha_index = require('./captcha/index.cjs');
const plugins_oneTimeToken_index = require('../shared/better-auth.DfaynrsJ.cjs');
